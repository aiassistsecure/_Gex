          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <ul className="mt-6 space-y-4 text-slate-300">
                <li>â€¢ Answer repetitive questions instantly</li>
                <li>â€¢ Keep replies aligned with your policies and tone</li>
                <li>â€¢ Review drafts before they go live when risk is high</li>
                <li>â€¢ Step in seamlessly when a human should take over</li>
              </ul>
            </div>
          </div>
        </section>
              ...
              <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                    ...
                    youâ€™re ready, paid plans begin at $19.99/month.
                  </p>
                  <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                    <a
                ...
                <div className="rounded-3xl border border-white/10 bg-[#11162a] p-8">
                  ...
                  <div className="mt-8 space-y-4 text-slate-300">
                    ...
                    <div className="flex items-center justify-between rounded-2xl bg-white/5 px-4 py-4">
                      <span>Small Team (2â€“10 seats)</span>
                      <span className="font-semibold text-white">$9.99/seat</span>
                    </div>
                    <div className="flex items-center justify-between rounded-2xl bg-white/5 px-4 py-4">
                      <span>Team (11â€“50 seats)</span>
                      <span className="font-semibold text-white">$7.99/seat</span>
                    </div>
                  </div>

                  <ul className="mt-8 space-y-3 text-sm text-slate-400">
                    <li>â€¢ Free tier available forever</li>
                    <li>â€¢ Pro and team plans include email support</li>
                    <li>â€¢ Enterprise includes white-labeling and dedicated support</li>
                  </ul>
                </div>
              </div>
            </div>
