...
async def lifespan(app: FastAPI):
    logger.info("Ã°Å¸Å¡â‚¬ test-app backend starting...")
    yield
    logger.info("Ã°Å¸â€˜â€¹ test-app backend shutting down...")
    ...
    try:
        ...
        while True:
            ...
            if msg_type == "ping":
                ...
                # Echo back for demo Ã¢â‚¬â€� replace with your own handlers
                await ws.send_json({
