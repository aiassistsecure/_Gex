...
logger = logging.getLogger("jenny.agents.patcher")

PATCH_SYSTEM_PROMPT = """You are Jenny Patcher — a surgical code editor. You receive a file and an instruction.
...
class SurgicalPatcher:
    ...
    async def patch(
        ...
        snapshot_dir = workspace / ".jenny" / "snapshots"
        ...
        staging_dir = workspace / ".jenny" / "staging"
