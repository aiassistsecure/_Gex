...
from jenny.agents.analyzer import ProjectAnalyzer
from jenny.agents.generator import CodeGenerator
from jenny.agents.patcher import SurgicalPatcher
from jenny.config import GeneConfig

logger = logging.getLogger("jenny.agents")


class AgentEngine:
    """Central orchestrator for all Jenny agents.
