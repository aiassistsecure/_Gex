...
logger = logging.getLogger("gene.agents.generator")

SYSTEM_PROMPT = """You are Gene, an expert code generator for desktop applications built with Python + Electron.
...
class CodeGenerator:
    ...
    async def generate(
        ...
        staging_dir = Path(target_path) / ".gene" / "staging"
